...
urlpatterns = [
    ...
    path('createtask/logout', clogout, name='clogout'),
    ...
    path('estatus/completedtasks', completedtasks, name='completedtasks'),
    path('estatus/cdashboard', cdashboard, name='cdashboard'),
    path('estatus/clogout', clogout, name='clogout'),
